...
export const midiToFrequency = (note: number, tuning: number = DEFUALT_TUNING): number => {
	return Math.pow(2, (note - NOTE_OFFSET) / NOTES_PER_OCTAVE) * tuning;
};

export const frequencyToMidi = (frequency: number, tuning: number = DEFUALT_TUNING): number => {
